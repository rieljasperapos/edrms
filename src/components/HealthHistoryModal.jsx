...
function HealthHistoryModal({ propSetModalVisible }) {
          ...
          <div className="flex w-5/6 flex-col gap-x-4 gap-y-5 self-center px-8 pb-4">
            <div className="grid sm:grid-cols-2 lg:grid-cols-3">
              ...
              {editMode ? (
                ...
                <div className="mb-1 flex justify-center font-Karla text-base font-bold text-black">
                  NO
                </div>
              )}
            </div>
            ...
            <div className="flex flex-col">
              ...
              {editMode ? (
                ...
                <div className="mb-1 font-Karla text-base text-black">None</div>
              )}
            </div>
            <div className="flex flex-col">
              <div className="mb-1 font-Karla text-base font-bold text-black">

...
function AddRecord() {
    return (
        <>
            <h1 className="text-black font-bold text-3xl uppercase font-Monsterrat mb-4">Add Record</h1>

            <div className="flex flex-col lg:flex-row justify-between bg-white border px-10 shadow-xl rounded-2xl flex-wrap">
                <div className="flex flex-row gap-x-16 justify-between flex-wrap mt-10">

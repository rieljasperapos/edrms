...
router.post('/totalCancelled', appointmentsController.getTotalAppointmentsCancelled);
router.post('/totalConfirmed', appointmentsController.getTotalAppointmentsConfirmed);
